...
class WaypointFollower(Node):
    def __init__(self):
        ...
        #self.target_position_initial           = None  # REPLACE WITH SAM Head POSITION 
        #self.target_position_final             = None  # REPLACE WITH BUOY POSITION
        ...
        self.wp_pub = self.create_publisher(PoseStamped, 'move_to_setpoint', 10)  # CHANGE THE TOPIC if u need  
    ...
    def declare_parameters(self):
        """Declares parameters for target positions."""
        self.declare_parameter("target_position_initial", [10.0, 10.0, 0.0])
        self.declare_parameter("target_position_final", [10.0, 11.6, 0.0])
        
        self.target_position_initial = np.array(
            self.get_parameter("target_position_initial").get_parameter_value().double_array_value
        )
        self.target_position_final = np.array(
            self.get_parameter("target_position_final").get_parameter_value().double_array_value
        )
